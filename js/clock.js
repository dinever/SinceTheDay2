...
(function($){
	...
	function animation(clock, current, total)
	{
		...
		if(clock==gVars.red){clock.words.html('days');}
		if(clock==gVars.orange){clock.words.html('hours');}
		if(clock==gVars.blue){clock.words.html('minutes');}
		if(clock==gVars.green){clock.words.html('seconds');}
	}
